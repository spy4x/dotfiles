...
Run the full checks once. Do not reread unchanged files. If the fix rewrote most of the diff, say
so and ask for a fresh reviewer.
...
```
Reviewed commit: <full hash of the HEAD you reviewed>
